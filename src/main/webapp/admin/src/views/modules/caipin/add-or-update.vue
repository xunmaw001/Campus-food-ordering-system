    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="金额" prop="caipinNewMoney">
                       <el-input v-model="ruleForm.caipinNewMoney"
                                 placeholder="金额" clearable  :readonly="ro.caipinNewMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="金额" prop="caipinNewMoney">
                           <el-input v-model="ruleForm.caipinNewMoney"
